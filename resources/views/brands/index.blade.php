...
@section("title", "Brends")

@section("breadcrumb")
    @include("components.partials.breadcrumb", ["title" => "Brends", "subTitle" => "Esasy"])
@endsection
                ...
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="card-title">
                        ...
                        <h3 class="card-title align-items-start flex-column">
                            <span class="card-label fw-bold text-gray-800">Brends</span>
                        ...
                        <div class="modal fade" id="createModal" tabindex="-1" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                    ...
                                    <form method="POST" class="form" action="{{route("brands.store")}}" enctype="multipart/form-data">
                                        @csrf
                                ...
                                <div class="modal fade" id="updateModal{{$item->id}}" tabindex="-1" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            ...
                                            <form method="POST" class="form" action="{{route("brands.update", $item->id)}}" enctype="multipart/form-data">
                                                @csrf
                                                @method("PUT")
                                                <div class="modal-body">
                                                    <div class="fv-row mb-5">
